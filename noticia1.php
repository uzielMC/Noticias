...
?>
  ...
  <div class="container">
	<article>
		<header>
			<h1><?php echo $titulosN[$i]; ?> </h1>
			<?php print "<p>$autoresN[$i]</p>"?>
			<?php print "<p>$fechasN[$i]</p>"; ?>
		</header>
		<picture>
			<img class="card-img-top" src="LeerImagen.php?ID=<?php echo $IDN[$i]?>"  alt=""></img> 
		</picture>
		<section>
			<?php print "<p>$textosN[$i]</p>"; ?>
		</section>
	</article>
	<form action="megusta.php?ID=<?php echo $IDN[$i]?>" method="POST" enctype ="multipart/form-data">
        <div class="form-group">    
			<p><input type="submit" text="Me Gusta"/></p>
            <br>
        </div>
    </form>
